...
#include "CUnit_Error.h"
#include "CUnit_TestDB.h"   /* not needed here - included for user convenience */
#include "CUnit_TestRun.h"  /* not needed here - include (after BOOL define) for user convenience */
